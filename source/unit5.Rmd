...
We have learned how to compute mean, median, variance, and standard deviation. We can compute these summary statistics for each of the groups and compare them. Let’s run through an example. There is nothing hard conceptually, fortunately.
...
You can use Word or google doc or powerpoint or any software that you know how to use to make a good looking table. Here’s my attempt:
TODO: put the table from the google drive here
